...
// --- Types for BookAI / Scientific Work ---

export interface BookAISubItem {
    id: string;
    name: string;
    tooltipText: string;
    subtext?: string;
...
export interface BookAIAudience {
    id: string;
    name: string;
    subtext: string;
    description: string;
...
export interface ScientificDocType {
    id: string;
    name: string;
    subtext: string;
    tooltipText: string;
...
export type VerificationFile = BaseFile;
export type LabFile = BaseFile;
